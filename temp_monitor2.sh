...
echo -e "/dev/sda: \e[1;32m$t_sda\e[0m \n"
echo -e "/dev/sdb: \e[1;32m$t_sdb\e[0m \n"
echo -e "/dev/sdc: \e[1;32m$t_sdc\e[0m \n"
echo -e "/dev/sdd: \e[1;32m$t_sdd\e[0m \n"
echo -e "/dev/sde: \e[1;32m$t_sde\e[0m \n"
echo -e "/dev/sdf: \e[1;32m$t_sdf\e[0m \n"
echo -e "/dev/sdg: \e[1;32m$t_sdg\e[0m \n"
echo -e "/dev/sdh: \e[1;32m$t_sdh\e[0m \n"
